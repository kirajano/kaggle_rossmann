...
print(f"Random Forest Regresor yield {funct.metric(y_test, y_pred):.2f}% RMSPE as error")
...
# model = XGBRegressor()
# params = {"max_depth": [10, 15, 20], "n_estimators": [400, 500, 600],
#          "eta": [0.1], "subsample": [0.7], "colsample_bytree": [0.8]}
# # Tuning Model
# final_model = funct.model_tuning(model, params, x, y, features, n_splits=3)
# print(f'Best Score: {final_model.best_score_}')
# print(f'Best Hyperparameters: {final_model.best_params_}')

# print("**** Fiting tuned model on whole dataset ****")
# final_model.fit(dataset[features], dataset["Sales"])
# print("++++++ Model Building DONE ++++++")
# print("**** Exporting Model to Pickle ****")
# save_model = "rossmann_model.pkl"
# pickle.dump(final_model, open(save_model, "wb"))


### FINAL RUN WITH UNSEEN DATA ### 
print("++++++ Importing pickled Model ++++++")
saved_model = "rossmann_model.pkl"
load_model = pickle.load(open(saved_model, "rb"))
...
print(f"Prediction on Hold-Out Set: {funct.metric(y_test, y_pred):.2f}% RMSPE")
